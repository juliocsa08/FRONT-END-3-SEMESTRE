...
async function buscarIMCs() {
    ...
    for(let i = 0; i < dadoRetornados.length; i++) {
         template += `<tr>
                    <td>${dadoRetornados[i].nome}</td>
                    <td>${dadoRetornados[i].altura.toFixed(2)}</td>
                    <td>${dadoRetornados[i].peso}</td>
                    <td>${dadoRetornados[i].IMC.toFixed(1)}</td>
                    <td>${dadoRetornados[i].textoSituacao}</td>
                </tr>`
